...
def main():
    ...
    for master_path, dataset_filenames_path, scale, block_size in zip(master_paths, dataset_filenames_paths, scales, block_sizes):
        ...
        output_f.writelines('dataset_name,block_size,total_area,total_margin,total_overlap,size_std,block_util,total_blocks\n')
        ...
        for filename in filenames:
            ...
            if non_indexed:
                partitions = [spatial_quality_extractor.combine_partitions(partitions, block_size)]
            ...
            output_f.writelines('{},{},{},{},{},{},{},{}\n'.format(dataset_filename, block_size * 1024 * 1024, total_area, total_margin, total_overlap, size_std, block_util, total_blocks))
